...
export default function FontsNinja() {
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <nav className="py-4 px-6 flex items-center justify-around border-b">
        ...
        <Link href="/" className="flex items-center ml-5">
            <svg width="28" height="31" viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
              <path fillRule="evenodd" clipRule="evenodd" d="M18.7072 9.4045C18.3012 10.1865 17.6137 10.5704 17.1996 10.6106C16.7856 
              10.6508 16.0239 10.3604 15.9707 9.85795C15.9219 9.39589 17.7389 7.89666 18.8459 7.84945C18.9991 7.84292 19.1215 7.97953 
              19.1047 8.1328C19.0745 8.40649 18.9828 8.87376 18.7072 9.4045ZM15.4888 9.91773C15.2996 10.459 13.7684 10.5652 13.3384 
              10.4668C12.9084 10.3685 12.0946 9.74867 11.7363 8.90875C11.4731 8.29144 11.5019 7.77801 11.5472 7.51293C11.5673 7.39533 
              11.6896 7.30801 11.8258 7.31444C13.4339 7.39041 15.678 9.37639 15.4888 9.91773ZM27.1325 9.45491C26.72 9.20099 26.5337 9.74914 26.2144 
              9.74914C26.1267 8.94176 26.951 8.37403 27.0857 8.29078C27.2206 8.20733 27.3243 7.68643 26.7281 7.69173C26.2926 7.69173 25.8933 8.322 25.8933 
              8.322C25.8155 7.89485 26.2511 7.49892 26.3704 7.39476C26.7125 7.13431 26.1111 6.73317 25.6912 7.01964C25.1882 7.43127 25.0275 7.9834 25.0275 
              7.9834C24.9135 7.71245 25.1571 7.16553 25.2298 7.00403C25.3023 6.84254 25.0172 6.56648 24.5765 6.98842C24.058 7.47811 23.8921 8.39484 23.8921 
              8.39484C22.7664 8.06826 20.3055 8.07526 19.4312 8.43921C19.4312 8.43921 20.0673 4.27236 15.6863 2.25346C14.362 1.64324 12.6771 1.75062 11.5893 
              2.69167C11.7067 2.25781 11.7533 1.15999 11.3778 0.623858C11.3778 0.623858 9.9901 -0.0745277 9.04775 0.00655013C10.8089 1.79253 10.7407 2.82933 
              10.7071 3.58268C10.1901 1.66472 8.38787 0.124525 6.37906 0.193777C6.70862 1.24192 6.41286 2.65781 6.41286 2.65781C7.96001 2.41836 9.44077 3.20444 
              10.0191 5.48503C9.87721 5.7768 9.82014 6.46932 9.95602 6.71728L9.28032 6.224C7.35955 4.78106 3.24042 3.26717 2.13102 3.16556C1.02153 3.06395 0.150644 
              4.42534 0.0150536 5.38976C-0.120349 6.35418 0.688582 6.82551 1.20157 7.06146C1.71455 7.29741 2.92216 7.75483 3.21603 6.87887C5.66985 7.52333 7.99767 10.6143 
              7.73459 14.8612C6.34205 16.8837 3.82261 23.0009 6.6702 26.8929C6.07624 28.6618 5.99498 30.5211 6.80589 30.7891C7.5297 31.0024 9.69171 26.5598 9.84378 25.7957C9.49614 
              23.0122 11.0932 21.1602 13.6462 20.3634C14.4284 21.1384 14.5786 23.4065 14.6548 24.2579C14.7308 25.1094 15.2105 24.9552 15.3953 24.8024C17.3834 23.2523 19.4585 22.0626 
              19.6975 21.9752C20.7295 21.3749 20.7947 20.6981 19.7952 20.6544C18.7957 20.6108 17.8976 20.7855 17.8976 20.7855C19.4511 18.2204 22.0006 14.8397 18.1764 
              15.3167C18.856 12.8106 21.3975 
              10.4041 25.4558 10.7433C27.1036 10.7807 27.545 9.70893 27.1325 9.45491Z" fill="#00CA99" />
            </svg>
      ...
      <main className="flex-grow pt-14 pr-14 flex items-center justify-center px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-foreground  text-4xl sm:text-5xl md:text-5xl lg:text-[110px] 
          font-bold leading-tight sm:leading-tight md:leading-tight lg:leading-[114px] tracking-tight 
          mb-8 sm:mb-16 md:mb-24 lg:mb-40">
           <Image
            src={"https://res.cloudinary.com/di2gmbyng/image/upload/v1728723275/wtmvre9ggmv1vdb84rkm.png"}
            alt='Discover'
            height={80}
            width={80}
  ...
  steps: [
    ...
    "Install necessary UI components from shadcn.",
    "Install Lucide React for icons",
    "Configure next.config.js to allow Cloudinary image domain",
    "Install framer motion for the animation.",
    "Copy the provided code into your app/page.tsx file.",
  ],
  preview: {
    type: 'video',
    src: '/fonts_ninja.mp4',
...
import Image from 'next/image'
import Link from 'next/link'
import { ChevronDown, Search, Circle,
 ArrowUpRight, Hexagon, Facebook, ShoppingBag,
  ShieldAlertIcon, CircleAlert, CircleArrowDown } from 'lucide-react'
import { Button } from "@/components/ui/button"
import {
  DropdownMenu,
  DropdownMenuContent,
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute left-[-57%] top-[-4rem] w-full h-full">
        <Image
        src="https://res.cloudinary.com/di2gmbyng/image/upload/v1728723276/bev0qbpqn6jnmpvtcmz4.webp"
      ...
      <div className="absolute left-[48%] top-0 w-full h-full">
        <Image
          src="https://res.cloudinary.com/di2gmbyng/image/upload/v1728723276/dn7niyyuv1uyymqsxeqy.webp"
      ...
      <nav className="relative z-10 bg-black flex items-center justify-evenly px-10 py-4">
        <div className="flex items-center gap-10">
          ...
          src="https://res.cloudinary.com/di2gmbyng/image/upload/v1728723276/d5odyq3h9ujxjjuyrfju.svg" 
          alt="Solana Logo" width={120} height={40} />
      ...
      justify-center min-h-[calc(100vh-80px)] text-center px-4">
        <h1 className="text-2xl text-balance md:text-3xl lg:text-6xl 
        font-sans font-bold mb-6 max-w-4xl">
        ...
        <div className="flex space-x-4">
          <button className="px-6 py-3 bg-gradient-to-r from-purple-500 to-[#4b1785] 
          rounded-full text-white font-semibold transition-all duration-300 ease-in-out  hover:text-black hover:bg-none hover:bg-white">
            START BUILDING
          </button>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {[
              ...
              <div key={name} className="cursor-pointer w-24 h-12 bg-gray-800 rounded-md flex items-center justify-center">
  ...
  return (
    <div className="relative min-h-screen font-sans overflow-hidden">
      {isClient && (
        ...
        >
          <source src="https://res.cloudinary.com/di2gmbyng/video/upload/v1728723278/a5xlm78rabcomm1tm4zo.mp4" type="video/mp4" />
        </video>
      )}
      ...
      <nav className="fixed top-7 left-5 right-5 z-50 p-4 flex justify-between items-center">
          <div className="text-2xl flex justify-center flex-col font-bold">
            <Image src="https://res.cloudinary.com/di2gmbyng/image/upload/v1728727778/cred_pfri4a.svg" alt="CRED Logo" width={80} height={80} />
        ...
        <div className="flex flex-col items-center justify-center h-screen text-center px-4">
          ...
          <div className="absolute bottom-10 right-10">
            ...
            >
              <Image src="https://res.cloudinary.com/di2gmbyng/image/upload/v1728723275/jyqt2jwshqdimuet9ftc.web" height={50} width={80} alt="QR Code" />
              Download <br /> CRED
            </Link>
          </div>
        </div>
      ...
      <header className="border-b">
        <div className="container ml-8  py-4 flex items-center justify-between">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
           viewBox="0 0 115 182" className="h-[35px] w-[22px] opacity-85 
           hover:opacity-100"><path fill="#F0CDC2" stroke="#1616B4" stroke-linejoin="round" 
           d="M57.505 181v-45.16L1.641 103.171z"></path><path fill="#C9B3F5" stroke="#1616B4" 
           stroke-linejoin="round" d="M57.69 181v-45.16l55.865-32.669z"></path><path fill="#88AAF1" 
           stroke="#1616B4" stroke-linejoin="round" d="M57.506 124.615V66.979L1 92.28z"></path><path 
           fill="#C9B3F5" stroke="#1616B4" stroke-linejoin="round" d="M57.69 124.615V66.979l56.506 25.302z"></path>
           <path fill="#F0CDC2" stroke="#1616B4" 
           stroke-linejoin="round" d="M1 92.281 57.505 1v65.979z"></path><path fill="#B8FAF6" stroke="#1616B4" 
           stroke-linejoin="round" d="M114.196 92.281 57.691 1v65.979z"></path></svg>
          ...
          <div className="flex items-center space-x-4">
            ...
            <select className="rounded-md border border-gray-300 py-2 pl-3 pr-10 focus:border-[#a28bfe] focus:outline-none focus:ring-1 focus:ring-[#a28bfe]">
              <option>EN</option>
              <option>ES</option>
              <option>FR</option>
            </select>
...
steps: [
  ...
  "Install necessary UI components from shadcn.",
  "Install Lucide React for icons",
  "Configure next.config.js to allow Cloudinary and ethereum image domain",
  "Copy the provided code into your app/page.tsx file.",
],
  preview: {
    type: 'image',
